...
// Set bling to for some events....
    ...
    operator.povUp().whileTrue(new AlgaeManipulator(10,15));
    operator.povRight().whileTrue(new AlgaeManipulator(75,15));
    operator.povDown().whileTrue(new AlgaeManipulator(90,15));
